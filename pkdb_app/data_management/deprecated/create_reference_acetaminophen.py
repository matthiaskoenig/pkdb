...
# important for this script
DATABASEPATH = os.path.join(BASEPATH, "data")
LITERATUREPATH = os.path.join(DATABASEPATH, SUBSTANCE, "literature")
MASTERPATH = os.path.join(DATABASEPATH, "Master")
REFERENCESMASTERPATH = os.path.join(MASTERPATH, "Studies")
REFERENCESPATH = os.path.join(DATABASEPATH, SUBSTANCE, "Studies.tsv")


# important for other scripts
SUBJECTSPATH = os.path.join(DATABASEPATH, SUBSTANCE, "Subjects.tsv")
PHARMACOKINETICSPATH = os.path.join(DATABASEPATH, SUBSTANCE, "Pharmacokinetics.tsv")
INTERVENTIONSPATH = os.path.join(DATABASEPATH, SUBSTANCE, "Interventions.tsv")
DOSINGPATH = os.path.join(DATABASEPATH, SUBSTANCE, "Dosing.tsv")
INDIVIDUALPATH = os.path.join(DATABASEPATH, SUBSTANCE, "Individuals.tsv")
TIMECOURSEPATH = os.path.join(DATABASEPATH, SUBSTANCE, "Timecourse.tsv")
OUTPUTINDIVIDUALPATH = os.path.join(DATABASEPATH, SUBSTANCE, "OutputIndividuals.tsv")
