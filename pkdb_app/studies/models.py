...
class Study(Sidable, models.Model):
    ...
    creator = models.ForeignKey(User, related_name="creator_of_studies", on_delete=models.CASCADE,null=True)
    name = models.CharField(max_length=CHAR_MAX_LENGTH)
    design = models.CharField(max_length=CHAR_MAX_LENGTH, null=True, choices=STUDY_DESIGN_CHOICES)
    reference = models.ForeignKey(Reference, on_delete=True, related_name='study', null=True)
    ...
    interventionset = models.OneToOneField(InterventionSet, on_delete=models.SET_NULL, null=True)
    individualset = models.OneToOneField(IndividualSet, on_delete=models.SET_NULL, null=True)
