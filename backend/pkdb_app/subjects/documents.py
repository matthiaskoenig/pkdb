...
from ..documents import ObjectField, elastic_settings, info_node, study_field
...
class IndividualDocument(Document):
    ...
    study = study_field
    ex = fields.ObjectField(properties={"pk": fields.IntegerField("pk")})
...
class GroupDocument(Document):
    ...
    def get_queryset(self):
        ...
        return (
            super()
            .get_queryset()
            .select_related("study", "parent")
            .prefetch_related("characteristica")
        )
