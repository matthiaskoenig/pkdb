...
class CustomOpenAPISchemaGenerator(OpenAPISchemaGenerator):
    ...
    def get_schema(self, request=None, public=False):
        ...
        swagger.tags = [
            ...
            {"name": "groups", "description": "Query groups"},
            {"name": "individuals", "description": "Query individual subjects"},
            {"name": "info_nodes", "description": "Query info nodes"},
            {"name": "outputs", "description": "Query outputs"},
            {"name": "statistics", "description": "Query PK-DB statistics"},
            {"name": "studies", "description": "Query studies"},
            {"name": "interventions", "description": "Query interventions"},
            {
                "name": "subsets",
        ...
        for table in [
            ...
            if self._params(table, swagger):
                swagger.paths.get("/filter/").get("get")["parameters"] += self._params(
                    table, swagger
                )
