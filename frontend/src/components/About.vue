<template>
    <div id="about" class="main">
      ...
      <a href="mailto:koenigmx@hu-berlin.de" title="koenigmx@hu-berlin.de"><v-icon color="black"
                                                                                   small>fas fa-envelope</v-icon></a>&nbsp;
        ...
        To report an issue use
         <a href="https://github.com/matthiaskoenig/pkdb/issues/new" title="Report an issue" target="_blank">
                <v-icon color="black" small>fas fa-fire</v-icon></a> <a
            href="https://github.com/matthiaskoenig/pkdb/issues/new" title="Report an issue" target="_blank">https://github.com/matthiaskoenig/pkdb/issues/new</a>.
      </p>
