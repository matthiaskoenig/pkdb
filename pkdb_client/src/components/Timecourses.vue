        ...
        <md-table  md-height="800px" class="my-table" v-model="entries" v-if="count" md-card>
            ...
            <md-table-toolbar>
                <md-badge  class="md-square md-primary" :md-content="count">
                    <h3 class="md-title"  style="flex: 1" ><font-awesome-icon icon="chart-line" /> Timecourses  </h3>
                </md-badge>
            ...
            <md-table-row slot="md-table-row" slot-scope="{item}">
                <md-table-cell md-label="Pk"> <font-awesome-icon icon="chart-line" /> {{ item.pk }} </md-table-cell>
                ...
                -->
                <md-table-cell md-label="Timecourse"><TimecourseSmall :timecourse="item"/></md-table-cell>
...
export default {
    ...
    components: {
        ...
        TimecourseSmall: TimecourseSmall,
    },
    props: {
        api: String
    },
