        ...
        <md-table  md-height="800px" class="my-table" v-model="references" v-if="count" md-card>
            ...
            <md-table-toolbar>
                <md-badge  class="md-square md-primary" :md-content="count">
                    <h3 class="md-title"  style="flex: 1" ><font-awesome-icon icon="file-alt" />   References  </h3>
                </md-badge>
            ...
            <md-table-row slot="md-table-row" slot-scope="{item}">
                <md-table-cell md-label="Sid"> <font-awesome-icon icon="file-alt" />{{ item.sid }} </md-table-cell>
                <md-table-cell md-label="Pmid" ><a :href="'https://www.ncbi.nlm.nih.gov/pubmed/'+item.pmid" target="_blank">{{ item.pmid }}</a></md-table-cell>
