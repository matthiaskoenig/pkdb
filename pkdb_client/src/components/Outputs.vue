<template>
    <div class="container">
        <div class="row">
            <div class="col-1" />
            <div class="col-10" >
                <h1><font-awesome-icon icon="chart-bar" /> Outputs <span v-if="count">({{ count }})</span></h1>
            </div>
            <div class="col-1" >
        ...
        <div class="row">
            ...
            <table v-if="count" class="table table-responsive table-condensed table-hover">
                ...
                <tbody>
                <tr v-for="(output, index) in entries" :key="index">
                    <td>{{ output.sid }}</td>
                    <td>{{ output.name }}</td>
                </tr>
                </tbody>
...
export default {
    ...
    data() {
        return {
            entries: [],
            count: null,
            resource_url: this.api + '/outputs_read/?format=json',
            }
        }
}
</script>
