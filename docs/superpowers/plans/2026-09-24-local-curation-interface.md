...
3. Add a loopback HTTP service with launch-session authentication, CSRF/Origin/Host checks, constrained default-app file opening, and `pkdb curate` CLI lifecycle.
